    ...
    def __init__(self,shader, posicion_id, color_id, transformaciones_id, posicion_x, posicion_y, posicion_z, velocidad, direccion):
        ...
        self.vertices = np.append(self.vertices, np.array(
            [
                #Carro rojo
                #Chasis
                -0.05,0.04,0.0,1.0,  198/255,27/255,0/255,1.0,  #izquierda arriba
                -0.05,-0.04,0.0,1.0, 198/255,27/255,0/255,1.0,  #izquierda abajo
                -0.03,0.04,0.0,1.0,  198/255,27/255,0/255,1.0, #derecha arriba
                -0.03,-0.04,0.0,1.0, 198/255,27/255,0/255,1.0, # derecha abajo
                
                -0.03,0.01,0.0,1.0,  198/255,27/255,0/255,1.0,  #izquierda arriba
                -0.03,-0.01,0.0,1.0, 198/255,27/255,0/255,1.0,  #izquierda abajo
                -0.01,0.01,0.0,1.0,  198/255,27/255,0/255,1.0, #derecha arriba
                -0.01,-0.01,0.0,1.0, 198/255,27/255,0/255,1.0, # derecha abajo

                -0.01,0.03,0.0,1.0,  198/255,27/255,0/255,1.0,  #izquierda arriba
                -0.01,-0.03,0.0,1.0, 198/255,27/255,0/255,1.0,  #izquierda abajo
                0.05,0.03,0.0,1.0,  198/255,27/255,0/255,1.0, #derecha arriba
                0.05,-0.03,0.0,1.0, 198/255,27/255,0/255,1.0, # derecha abajo

                0.05,0.015,0.0,1.0,  198/255,27/255,0/255,1.0,  #izquierda arriba
                0.05,-0.015,0.0,1.0, 198/255,27/255,0/255,1.0,  #izquierda abajo
                0.065,0.015,0.0,1.0,  198/255,27/255,0/255,1.0, #derecha arriba
                0.065,-0.015,0.0,1.0, 198/255,27/255,0/255,1.0, # derecha abajo

                0.05,0.01,0.0,1.0,  198/255,27/255,0/255,1.0,  #izquierda arriba
                0.05,-0.01,0.0,1.0, 198/255,27/255,0/255,1.0,  #izquierda abajo
                0.1,0.01,0.0,1.0,  198/255,27/255,0/255,1.0, #derecha arriba
                0.1,-0.01,0.0,1.0, 198/255,27/255,0/255,1.0, # derecha abajo
